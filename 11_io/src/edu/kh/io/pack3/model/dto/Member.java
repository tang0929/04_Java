...
// 직렬화 방법 : Serializable 인터페이스를 상속받기



/* Serializable 인터페이스 
 * 추상 메서드가 하나도 없는 인터페이스 
 * 상속만 받아도 입/출력 시 직렬화가 가능하다는 의미만 제공 -> 마커 인터페이스 */



public class Member implements Serializable {
	
	// Serializable 인터페이스 상속까지 같이받기
	
	// serialVersionUID : 직렬화 식별 번호
	// -> 직렬화/역직렬화시 같은 객체가 맞는지 확인하는 식별 번호
	// 별도로 작성하지 않으면 JVM이 알아서 지정해줌
