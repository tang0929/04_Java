...
public class Person {
	...
	// ex) 123 -> qwerty
	//     abcdefghi -> asdfgh (암호화에 많이 사용)
	
	// hashCode() : 객체별 식별 코드(객체를 구분하는 정수 값) 반환
	// 비슷한 예로 주민등로번호, 학번, 은행 대기표 
	...
	public int hashCode() {
		...
		// return name.hashCode() + age * 31;로 작성했어야 됐음
	...
	public boolean equals(Object obj) {
		...
		// 현재 객체의 필드와 전달 받은 obj의 필드가 모두 같을 경우 true 아니면 false
		
		if(obj == null) return false; // null는 비교 불가
		
		if(obj == this) return true; // 현재 객체랑 비교
