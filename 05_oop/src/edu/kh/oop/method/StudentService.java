...
public class StudentService {
	...
	public void displayMenu() {
		...
		// (null : 참조하는 객체가 없음)
		Student std1 = new Student("홍길동","12345678",'남'); 
		Student std2 = null;
...
0. 프로그램 종료
			...
			case 5: 
				...
				break;
			case 6: String result = compareJava(std1, std2); System.out.println(result);
			case 7: String result2 = compareHtml(std1, std2); System.out.println(result2);
	...
	private String compareJava(Student s1, Student s2) {
		...
		// 전달 받은 s1에 참조하는 Student 객체가 없으면
		if(s1 == null) {
	...
	private String compareHtml(Student s1, Student s2) {
		...
		String result2 = String.format("std1 : %d / std2 : %d \n",s1.getHtml(),s2.getHtml());
		// 두 학생의 점수 비교
